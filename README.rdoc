...
* Change method & var names from camelcase to snake case
    x. stations.minsFromHome
    traintrips
    x. traintrips.trainleavesat
    x. trip_options.leave_house_by
    x. trip_options.train_leaves_at
* Add tests!
* Improve UI!
  x. Add "AM/PM"
  * Style station pages
